...
% set options
test_reflect = true;    % verify total reflectance or not
test_angular = true;    % verify angular reflectance or not
test_fluence = false;   % verify fluence or not (slow)
...
if test_reflect == true || test_angular == true
