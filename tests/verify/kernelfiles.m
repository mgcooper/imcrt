function files = kernelfiles()
   ...
   % result: the kernel, the functions its photon loop calls, the scale
   % functions that normalize its tallies, the grid builder, and the
   % derivative the builder calls. The driver's checkpoint
   ...
   files = {'src/mcrt.m', 'src/chgdir.m', 'src/hgcos.m', 'src/roulette.m', ...
      'src/binindex.m', 'src/scaleR.m', 'src/scaleT.m', 'src/scaleA.m', ...
      'src/tallyse.m', ...
      'src/buildgrid.m', 'src/derivative/derivative.m'};
end
