function mcrt_out = mcrt(mcrt_opts)

% TODO: score the first event, then begin while loop to avoid slow if/else
% TODO: get rid of if/else g==0, call a separate function for that case
...
if test_refl == true || test_ang == true
    ...
    Rdf_a(1)    = Rdf_a(1)+Rdr; % total reflectance
    Tdf_a(1)    = Tdf_a(1)+Tdr; % total transmittance
