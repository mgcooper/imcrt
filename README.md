...
A working installation of MATLAB. The test suite runs on MATLAB R2025b with no toolboxes. Older releases and GNU Octave are untested; the code keeps to core features that older releases and Octave have where that costs nothing. The project has no dependencies other than the code included here.
